...
public class GenomeToFunctions {
	...
	public GenomeToFunctions(Genome genome){
		...
		case FunctioT.Media_Partida_Classic_FaseSync_DoubleFrecuency_Knee:
			...
			backLeft2 = (new MoveFunctionSinDoubleFrecuency(genome.getAmplitude(1),genome.getPeriod(0),genome.getPeriod(1),genome.getFase(1),genome.getCenterAngle(1),genome.getStrength(0),genome.getAmplitude(7),secondPeriod,genome.getFase(7),genome.getCenterAngle(7),genome.getStrength(1)));
			...
			frontLeft2 = (new MoveFunctionSinDoubleFrecuency(genome.getAmplitude(4),genome.getPeriod(0),genome.getPeriod(1),genome.getFase(4),genome.getCenterAngle(4),genome.getStrength(0),genome.getAmplitude(10),secondPeriod,genome.getFase(10),genome.getCenterAngle(10),genome.getStrength(1)));
			...
			backRight2 = (new MoveFunctionSinDoubleFrecuency(genome.getAmplitude(1),genome.getPeriod(0),genome.getPeriod(1),genome.getFase(1) + Mathf.PI,genome.getCenterAngle(1),genome.getStrength(0),genome.getAmplitude(13),secondPeriod,genome.getFase(13),genome.getCenterAngle(13),genome.getStrength(1)));
			...
			frontRight2 = (new MoveFunctionSinDoubleFrecuency(genome.getAmplitude(4),genome.getPeriod(0),genome.getPeriod(1),genome.getFase(4) + Mathf.PI,genome.getCenterAngle(4),genome.getStrength(0),genome.getAmplitude(16),secondPeriod,genome.getFase(16),genome.getCenterAngle(16),genome.getStrength(1)));
