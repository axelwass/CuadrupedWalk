...
public class MoveFunctionMediaPartidaFourierRodilla : MoveFunction {
	...
	public MoveFunctionMediaPartidaFourierRodilla(float a1,float a2, float b1, float b2, float period, float fase, float centerAngle, float strength,
